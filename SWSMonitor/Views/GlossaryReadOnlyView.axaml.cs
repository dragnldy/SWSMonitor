...
public partial class GlossaryReadOnlyView : ReactiveUserControl<SpeciesReadOnlyViewModel>
{
    public GlossaryReadOnlyView()
    {
        //        InitializeComponent();
        this.WhenActivated((ReactiveUI.Primitives.Disposables.MultipleDisposable disposables) => { }); 
        AvaloniaXamlLoader.Load(this);

        var vm = new SpeciesReadOnlyViewModel() { ID = 0 };
        this.ViewModel = vm;
        this.DataContext = vm;
    }
